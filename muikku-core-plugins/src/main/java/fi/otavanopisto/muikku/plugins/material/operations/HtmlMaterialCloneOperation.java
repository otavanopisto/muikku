...
public class HtmlMaterialCloneOperation implements MaterialCloneOperation<HtmlMaterial> {
  ...
  public HtmlMaterial clone(HtmlMaterial material) {
    return htmlMaterialController.createHtmlMaterial(material.getTitle(), material.getHtml(), material.getContentType(), new Long(0), material, material.getLicense(), material.getVisibility());
  }
