...
import fi.otavanopisto.muikku.model.chat.ChatUser;
...
public class ChatController {
  ...
  public void handleSettingsChange(UserEntity userEntity, ChatUserVisibility visibility, String nick, String sessionId) {
    ...
    if (chatUser == null && visibility == ChatUserVisibility.NONE) {
      ...
      boolean nickChange = !StringUtils.equals(chatUser.getNick(), nick);
      boolean visibilityChange = visibility != chatUser.getVisibility(); 
