...
import static fi.muikku.plugins.calendar.CalendarEventRecurrenceParser.*;
 ...
 */
public class UserCalendarEventRecurrence implements CalendarEventRecurrence {
  ...
  public UserCalendarEventRecurrence(CalendarEventRecurrenceFrequency frequency, Integer interval, CalendarEventTemporalField until, TimeZone timeZone, Locale locale) {
  ...
  public UserCalendarEventRecurrence(CalendarEventRecurrenceFrequency frequency, Integer interval, Integer count, TimeZone timeZone, Locale locale) {
    this.timeZone = timeZone;
    this.locale = locale;
  ...
  public UserCalendarEventRecurrence(String icalRecurrence, TimeZone timeZone, Locale locale) throws CalendarServiceException {
    this.timeZone = timeZone;
    this.locale = locale;

    this.frequency = findFrequency(icalRecurrence);
    this.until = new UserCalendarEventTemporalField(
