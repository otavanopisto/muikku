...
import fi.muikku.plugins.communicator.model.CommunicatorMessageAttachment_;
...
@DAO
public class CommunicatorMessageAttachmentDAO extends CoreDAO<CommunicatorMessageAttachment> {
