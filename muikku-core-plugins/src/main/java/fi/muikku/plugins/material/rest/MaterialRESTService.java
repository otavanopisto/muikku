...
//  @Path("/material/{ID:[0-9]*}/workspaceMaterials/")
  ...
  private fi.muikku.plugins.workspace.rest.model.WorkspaceMaterial[] createRestModel(WorkspaceMaterial... workspaceMaterials) {
    ...
    return result.toArray(new fi.muikku.plugins.workspace.rest.model.WorkspaceMaterial[0]);
  }
