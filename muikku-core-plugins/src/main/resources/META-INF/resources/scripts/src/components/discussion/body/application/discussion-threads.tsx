...
class DiscussionThreads extends React.Component<DiscussionThreadsProps, DiscussionThreadsState> {
  ...
  render(){
    ...
    return <BodyScrollKeeper hidden={!!this.props.discussion.current}><div className="application-list application-list__items">{
    ...
    }<Pager onClick={this.getToPage} current={this.props.discussion.page} pages={this.props.discussion.totalPages}/></div></BodyScrollKeeper>
  }
}
