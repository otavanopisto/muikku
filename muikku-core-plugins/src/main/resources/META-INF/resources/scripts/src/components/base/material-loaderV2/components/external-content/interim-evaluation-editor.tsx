...
import { updateCurrentWorkspaceInterimEvaluationRequests } from "~/actions/workspaces/index";
...
> {
  ...
  constructor(props: InterimEvaluationEditorProps) {
    ...
    const requestData = props.getInterimEvaluationRequest();
  ...
  shouldComponentUpdate(
    ...
    return (
      ...
      (this.props.context.tool === "materials" &&
  ...
  handlePushInterimRequest = async () => {
    ...
    if (this.props.stateConfiguration.states.includes("SUBMITTED")) {
      try {
 ...
 */
  ...
  render() {
    ...
    const isSubmitted =
      ...
      this.props.stateConfiguration.states.includes("SUBMITTED");
    const isEvaluated =
      this.props.stateConfiguration &&
      this.props.stateConfiguration.states.includes("PASSED");
      ...
      <div className="material-page__buttonset">
        {!this.props.stateConfiguration.button.disabled ? (
          <Button
            ...
            buttonModifiers={this.props.stateConfiguration.button.className}
            onClick={this.handlePushInterimRequest}
          >
            {t(this.props.stateConfiguration.button.text, {
              ns: "workspace",
              defaultValue: this.props.stateConfiguration.button.text,
            })}
          </Button>
        ) : null}
        {this.props.stateConfiguration.behavior.displaysHideShowAnswersButton &&
