...
class WorkspaceJournals extends BodyScrollLoader<WorkspaceJournalsProps, WorkspaceJournalsState> {
  constructor(props: WorkspaceJournalsProps){
    ...
    this.loadMoreTriggerFunctionLocation = "loadMoreCurrentWorkspaceJournalsFromServer";
  }

  render(){
    if (!this.props.workspace || !this.props.workspace.journals || this.props.workspaceJournalsState === "LOADING"){
      return null;
    ...
    return (<ApplicationList>
      ...
      {this.props.workspaceJournalsState === "LOADING_MORE" ? <ApplicationListItem className="loader-empty"/> : null}
    </ApplicationList>);
  }
}
...
function mapDispatchToProps(dispatch: Dispatch<any>){
  return bindActionCreators({loadMoreCurrentWorkspaceJournalsFromServer}, dispatch);
};
