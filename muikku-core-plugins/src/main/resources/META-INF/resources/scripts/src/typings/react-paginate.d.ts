declare module "react-paginate" {
  ...
  /**
   * Forked interface from ReactPaginateProps because that component typescript
   * definitions are lacking behind the actual component releases
   */
  export interface ReactPaginateForkProps {
    /**
     * nextAriaLabel
     */
    ...
    /**
     * The initial page selected. Indexing starts from 0
     */
  ...
  /**
   * Forked React Paginate component.
   * Paginate component items indexing starts from 0. Remember that when defining current page or
   * page changes
   */
  declare const ReactPaginateForked: React.ComponentClass<ReactPaginateForkProps>;
  export default ReactPaginateForked;
}
