...
export default function Image(props: {
  ...
  return <div className="material-page__content material-page__content--binary-image">
    <Zoom imgsrc={`/rest/materials/binary/${props.material.materialId}/content`}>
      <img src={`/rest/materials/binary/${props.material.materialId}/content`} className="zoom-image"/>
    </Zoom>
  </div>;
}
