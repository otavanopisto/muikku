...
class OrganizationUsers extends React.Component<OrganizationUsersProps, OrganizationUsersState> {
  ...
  render() {
    return (<div>
      <UserPanel i18n={this.props.i18n} identifier={"staff"} onEmpty="plugin.organization.users.staff.empty" searchString={this.props.users.staff.searchString} title="plugin.organization.users.staff.title" users={this.props.users.staff} pageChange={this.staffPanelPageChange} />
      <UserPanel i18n={this.props.i18n} identifier={"students"} onEmpty="plugin.organization.users.students.empty" searchString={this.props.users.students.searchString} title="plugin.organization.users.students.title" users={this.props.users.students} pageChange={this.studentPanelPageChange} />
    </div>)
  }
}
