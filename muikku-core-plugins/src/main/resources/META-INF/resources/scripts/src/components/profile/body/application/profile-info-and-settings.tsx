  ...
  render() {
    ...
    return (<div className="profile-element">
      ...
      <form>
        ...
        {!this.props.status.isStudent ?
          <div className="profile-element__item">
            <DateFormElement labels={vacationStartLabels} id="profileVacationStart" updateField={this.handleDateChange.bind(this, "profileVacationStart")}
        ...
        {!this.props.status.isStudent ?
          <div className="profile-element__item">
            <DateFormElement labels={vacationEndLabels} id="profileVacationEnd" updateField={this.handleDateChange.bind(this, "profileVacationEnd")}
