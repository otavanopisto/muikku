...
class DeleteWorkspaceMaterialDialog extends React.Component<DeleteWorkspaceMaterialDialogProps, DeleteWorkspaceMaterialDialogState> {
  ...
  render(){
    let content = (closeDialog: ()=>any) => <div>
      <span>{this.props.i18n.text.get(this.props.isSection ?
