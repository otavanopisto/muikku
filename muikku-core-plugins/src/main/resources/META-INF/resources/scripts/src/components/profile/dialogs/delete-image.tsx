...
import { deleteProfileImage, DeleteProfileImageTriggerType } from '~/actions/main-function/profile';
...
class DeleteImageDialog extends React.Component<DeleteImageDialogProps, DeleteImageDialogState> {
  ...
  render(){
    ...
    return <Dialog isOpen={this.props.isOpen} onClose={this.props.onClose} title={this.props.i18n.text.get('plugin.profile.deleteImage.dialog.title')}
      content={content} footer={footer} modifier="delete-image"/>
  }
}
