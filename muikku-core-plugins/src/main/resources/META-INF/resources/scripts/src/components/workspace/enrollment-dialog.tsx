...
class EnrollmentDialog extends React.Component<EnrollmentDialogProps, EnrollmentDialogState> {
  render(){
    ...
    let content = (closeDialog: ()=>any)=>{
      return (
        <div className="dialog__content-row dialog__content-row--label">
          <img src="/gfx/icons/64x64/certificate.png" alt="Enrollment logo" title="Enrollment logo" className="logo--enrollment-logo" />
