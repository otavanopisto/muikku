    ...
    return (
      <div>
        <ApplicationSubPanel i18n={this.props.i18n} modifier="workspace-users" bodyModifier="workspace-staff-members" title={this.props.i18n.text.get('plugin.organization.summary.billing.title')}>
          <ApplicationSubPanelItem title={this.props.i18n.text.get('plugin.organization.summary.billing.subtitle.activeBillingPeriod')}>
            <ApplicationSubPanelItem.Content>
              DD.MM.YYYY - DD.MM.YYYY
            </ApplicationSubPanelItem.Content>
            <ApplicationSubPanelItem.Content label={this.props.i18n.text.get('plugin.organization.summary.billing.detail.nextBillingSeason')} >
              DD.MM.YYYY - DD.MM.YYYY
            </ApplicationSubPanelItem.Content>
          </ApplicationSubPanelItem>
          <ApplicationSubPanelItem title={this.props.i18n.text.get('plugin.organization.summary.billing.subtitle.accumulatedBill')} >
          ...
          <ApplicationSubPanelItem title={this.props.i18n.text.get('plugin.organization.summary.billing.subtitle.previousBills')} >
            <ApplicationSubPanelItem.Content>1000€</ApplicationSubPanelItem.Content>
            <ApplicationSubPanelItem.Content>
              {this.props.i18n.text.get('plugin.organization.summary.billing.detail.accumulated', 10, 5, 3)}
            </ApplicationSubPanelItem.Content>
        ...
        <ApplicationSubPanel i18n={this.props.i18n} modifier="workspace-users" bodyModifier="workspace-staff-members" title={this.props.i18n.text.get('plugin.organization.summary.contact.title')}>
          <ApplicationSubPanelItem title={this.props.i18n.text.get('plugin.organization.summary.contact.subtitle')} >
            <ApplicationSubPanelItem.Content>
              <div>Musta kaapu</div>
