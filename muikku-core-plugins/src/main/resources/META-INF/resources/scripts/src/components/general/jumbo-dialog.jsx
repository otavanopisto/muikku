...
export default class JumboDialog extends Dialog {
  render(){
    return (
        <Portal onKeyStroke={this.props.onKeyStroke} openByClickOn={this.props.children} onOpen={this.onOpen} onClose={this.props.onClose} beforeClose={this.beforeClose} closeOnEsc>
