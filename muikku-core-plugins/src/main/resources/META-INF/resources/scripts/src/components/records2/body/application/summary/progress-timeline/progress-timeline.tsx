...
const ProgressTimeline: React.FC<ProgressTimelineProps> = (props) => {
  ...
  const items: TimelineItemModel[] = [
    {
      title: "Toukokuu 2020",
      cardTitle: "Opintojen aloitus",
      cardDetailedText: "Aloitit opintosi toukokuussa 2021",
    },
    {
      title: "Toukokuu 2020",
      cardTitle: "Ensimmäinen kurssisuoritus",
      cardDetailedText:
        "Suoritit ensimmäisen kurssisi, joka oli Matematiikka 1: Kaavat ja numerot",
    },
    {
      title: "Heinäkuu 2020",
      cardTitle: "Keskeytysjakso alkaa",
      cardDetailedText:
        "Keskeytit opintosi kahdeksi kuukaudeksi ajalle heinä-syyskuu.",
    },
    {
      title: "Syyskuu 2020",
      cardTitle: "Keskeytysjakso päättyy",
      cardDetailedText: "Opintojesi keskeytysjakso päättyi ja opinnot jatkuvat",
    },
  ];
