 ...
 */
interface StudyProgressWatcherContextProviderProps {
 ...
 * @returns JSX.Element
 */
const StudyProgressWatcher = (
  props: StudyProgressWatcherContextProviderProps
) => {
  const { children, currentStudent, websocketState, updateStudyProgress } =
    props;
  ...
  }, [currentStudent.studyProgress, updateStudyProgress, websocketState]);
