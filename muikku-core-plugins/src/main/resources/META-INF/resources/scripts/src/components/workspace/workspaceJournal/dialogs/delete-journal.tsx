...
import { deleteWorkspaceJournalInCurrentWorkspace, DeleteWorkspaceJournalInCurrentWorkspaceTriggerType } from '~/actions/workspaces';
      ...
      return (          
         <div className="dialog__button-set">
          <Button buttonModifiers={["fatal", "standard-ok"]}
            ...
            {this.props.i18n.text.get('plugin.workspace.journal.deleteEntry.dialog.deleteButton')}
          </Button>
          <Button buttonModifiers={["cancel", "standard-cancel"]} onClick={closeDialog}>
            {this.props.i18n.text.get('plugin.workspace.journal.deleteEntry.dialog.cancelButton')}
          </Button>
        </div>
      )
    }
...
function mapDispatchToProps(dispatch: Dispatch<AnyActionType>){
  return bindActionCreators({deleteWorkspaceJournalInCurrentWorkspace}, dispatch);
};
