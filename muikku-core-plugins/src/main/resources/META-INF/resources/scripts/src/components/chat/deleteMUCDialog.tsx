...
class DeleteRoomDialog extends React.Component<DeleteRoomDialogProps, DeleteRoomDialogState> {
  ...
  async delete(closeDialog: ()=>any){
    try {
      ...
      this.props.displayNotification(this.props.i18n.text.get("plugin.chat.notification.roomDeleteSuccess", this.props.chat.roomName), "success");
      this.props.onDelete();
    } catch {
      this.props.displayNotification(this.props.i18n.text.get("plugin.chat.notification.roomDeleteFail", this.props.chat.roomName), "error");
    }
  }
  ...
  render(){
    let content = (closeDialog: ()=>any)=><div>
      <span dangerouslySetInnerHTML={{ __html: this.props.i18n.text.get('plugin.chat.rooms.deleteRoomDesc', this.props.chat.roomName)}}></span>
      </div>;
