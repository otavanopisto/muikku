    ...
    let content = (closePortal: () => any) =>
      <div>
        ...
        <DialogRow modifiers="new-user">
          ...
          <InputFormElement id="lastName" value={this.state.user.lastName} name="firstName" modifiers="new-user" valid={this.state.lastNameValid} mandatory={true} label={this.props.i18n.text.get('plugin.organization.users.addUser.label.lastName')} updateField={this.updateField} />
