  ...
  return async (
    ...
    try {
      ...
      dispatch(
        notificationActions.displayNotification(
          getState().i18nOLD.text.get(
            "plugin.organization.update.student.error"
          ),
          "error"
        )
      );
    ...
    return async (
      ...
      try {
        ...
        dispatch(
          notificationActions.displayNotification(
            getState().i18nOLD.text.get(
              "plugin.organization.create.staff.error"
            ),
            "error"
          )
        );
    ...
    return async (
      ...
      try {
        ...
        dispatch(
          notificationActions.displayNotification(
            getState().i18nOLD.text.get(
              "plugin.organization.update.staff.error"
            ),
            "error"
          )
        );
  ...
  function loadStudyprogrammes() {
    return async (
      ...
      try {
        ...
        dispatch(
          notificationActions.displayNotification(
            getState().i18nOLD.text.get("TODO: Error"),
            "error"
          )
        );
      }
...
const loadUserGroups: LoadUsergroupsTriggerType = function loadUserGroups(
  ...
  return async (
    ...
    try {
      ...
      dispatch(
        notificationActions.displayNotification(
          getState().i18nOLD.text.get("Load failed"),
          "error"
        )
      );
      dispatch({
...
const loadMoreUserGroups: LoadUsersTriggerType = function loadMoreUserGroups() {
  return async (
    ...
    try {
      ...
      dispatch(
        notificationActions.displayNotification(
          getState().i18nOLD.text.get("Loadmore failed"),
          "error"
        )
      );
      dispatch({
