...
import {WorkspaceListType, WorkspaceStudentActivityType, WorkspaceForumStatisticsType, WorkspaceActivityStatisticsType, WorkspaceActivityRecordType} from '~/reducers/workspaces';
