...
// interface ManagementSignupMessageFormProps extends WorkspaceSignupMessage {
//   identifier?: string;
// }

// const ManagementSignupMessageForm = (
//   props: ManagementSignupMessageFormProps
// ) => {
//   const { caption, content, enabled } = props;
//   const { t } = useTranslation(["workspace"]);
...
//               type="checkbox"
//               className={`button-pill button-pill--autoreply-switch ${
//                 enabled ? "button-pill--autoreply-switch-active" : ""
//               }`}
//               checked={enabled}
//               disabled={caption === "" || content === ""}
...
//           ancestorHeight={200}
//           onChange={(text: string) =>
//             handleWorkspaceSignupMessageContentChange(index, text)
//           }
//         >
//           {content}
//         </CKEditor>
