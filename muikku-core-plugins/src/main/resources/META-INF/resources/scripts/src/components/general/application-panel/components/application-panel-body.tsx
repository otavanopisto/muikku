...
> {
  ...
  calculate() {
    ...
    this.offsetBorderAgainstBottom = parseInt(
  ...
  setRemainingHeight(isSticky: boolean) {
    ...
    let borderBottomSize =
      this.offsetBorderAgainstBottom - bottom + this.borderWidth;
          ...
          style={
            this.state.sticky
              ? {
                  ...
                  left: !this.state.mobileWidth
                    ? this.state.extraPaddingLeft
                    : 0,
                  right: !this.state.mobileWidth
                    ? this.state.extraPaddingRight
                    : 0,
                }
              : null
          }
