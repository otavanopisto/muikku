...
export interface LOAD_CREDENTIALS
  extends SpecificActionType<"LOAD_CREDENTIALS", CredentialsType> {}
export interface CREDENTIALS_STATE
  extends SpecificActionType<"CREDENTIALS_STATE", CredentialsStateType> {}
...
let loadCredentials: LoadCrendentialsTriggerType = function loadCredentials(
  secret
) {
  return async (
...
let updateCredentials: UpdateCredentialsTriggerType =
