...
class CheckContactInfoDialog extends React.Component<CheckContactInfoDialogProps, CheckContactInfoDialogState> {
  ...
  render(){
    let content = (closeDialog: ()=>any)=><div>
        ...
        <dt>{this.props.i18n.text.get("plugin.frontPage.checkContactInfo.dialog.postalCode")}</dt>
        <dd>{this.state.address.postalCode ? this.state.address.postalCode : "-"}</dd>
        <dt>{this.props.i18n.text.get("plugin.frontPage.checkContactInfo.dialog.city")}</dt>
        <dd>{this.state.address.city ? this.state.address.city : "-"}</dd>
        <dt>{this.props.i18n.text.get("plugin.frontPage.checkContactInfo.dialog.country")}</dt>
        <dd>{this.state.address.country ? this.state.address.country : "-"}</dd>
        <dt>{this.props.i18n.text.get("plugin.frontPage.checkContactInfo.dialog.municipality")}</dt>
    ...
    return <Dialog title={this.props.i18n.text.get('plugin.frontPage.checkContactInfo.dialog.title')}
      content={content} footer={footer} modifier="check-contact-info" isOpen={this.state.isOpen}/>
  }
}
