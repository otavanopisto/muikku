...
//
//export interface UPDATE_WORKSPACES_AVALIABLE_FILTERS_EDUCATION_TYPES extends SpecificActionType<"UPDATE_WORKSPACES_AVALIABLE_FILTERS_EDUCATION_TYPES", CourseEducationFilterListType>{}
//export interface UPDATE_WORKSPACES_AVALIABLE_FILTERS_CURRICULUMS extends SpecificActionType<"UPDATE_WORKSPACES_AVALIABLE_FILTERS_CURRICULUMS", CourseCurriculumFilterListType>{}
//export interface UPDATE_WORKSPACES_ACTIVE_FILTERS extends 
//  SpecificActionType<"UPDATE_WORKSPACES_ACTIVE_FILTERS", CoursesActiveFiltersType>{}
//export interface UPDATE_WORKSPACES_ALL_PROPS extends 
//  SpecificActionType<"UPDATE_WORKSPACES_ALL_PROPS", CoursesPatchType>{}
//export interface UPDATE_WORKSPACES_STATE extends 
//  SpecificActionType<"UPDATE_WORKSPACES_STATE", CoursesStateType>{}
//  
