...
import { cancelAssessmentAtWorkspace, CancelAssessmentAtWorkspaceTriggerType } from '~/actions/workspaces';
...
class EvaluationCancelDialog extends React.Component<EvaluationCancelDialogProps, EvaluationCancelDialogState> {
      ...
      return (          
        <div className="dialog__button-set">
          ...
          <Button buttonModifiers={["standard-cancel", "cancel"]} onClick={closeDialog} disabled={this.state.locked}>
            {this.props.i18n.text.get('plugin.workspace.evaluation.cancelEvaluation.cancelButton')}
          </Button>
        </div>
      )
    }
