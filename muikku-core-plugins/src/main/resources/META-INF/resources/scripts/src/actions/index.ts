...
import { UPDATE_STUDENT_USERS, UPDATE_STAFF_USERS, UPDATE_USER_GROUPS, UPDATE_STUDENT_SELECTOR,
  UPDATE_STAFF_SELECTOR, UPDATE_GROUP_SELECTOR, CLEAR_USER_SELECTOR, UPDATE_USERS_STATE, UPDATE_STUDYPROGRAMME_TYPES,
  UPDATE_STUDYPROGRAMME_STATUS_TYPE, UPDATE_CURRENT_USER_GROUP, UPDATE_USER_GROUPS_STATE, UPDATE_HAS_MORE_USERGROUPS, SET_CURRENT_PAYLOAD
...
import {
  ...
  UPDATE_WORKSPACES_AVAILABLE_FILTERS_CURRICULUMS, UPDATE_WORKSPACES_AVAILABLE_FILTERS_STATE_TYPES, UPDATE_WORKSPACES_AVAILABLE_FILTERS_EDUCATION_TYPES, UPDATE_WORKSPACES_STATE,
  ...
  UPDATE_ORGANIZATION_WORKSPACES_AVAILABLE_FILTERS_EDUCATION_TYPES, UPDATE_ORGANIZATION_WORKSPACES_AVAILABLE_FILTERS_STATE_TYPES, UPDATE_ORGANIZATION_WORKSPACES_AVAILABLE_FILTERS_CURRICULUMS, UPDATE_ORGANIZATION_WORKSPACES_ALL_PROPS, UPDATE_ORGANIZATION_SELECTED_WORKSPACE,
...
export type ActionType = SET_CURRENT_MESSAGE_THREAD | UPDATE_MESSAGES_STATE |
  ...
  UPDATE_ORGANIZATION_WORKSPACES_AVAILABLE_FILTERS_EDUCATION_TYPES | UPDATE_ORGANIZATION_WORKSPACES_AVAILABLE_FILTERS_STATE_TYPES |
  UPDATE_ORGANIZATION_WORKSPACES_AVAILABLE_FILTERS_CURRICULUMS | UPDATE_ORGANIZATION_WORKSPACES_ALL_PROPS |
  UPDATE_ORGANIZATION_WORKSPACES_ACTIVE_FILTERS | UPDATE_ORGANIZATION_WORKSPACES_STATE | UPDATE_ORGANIZATION_SELECTED_WORKSPACE | UPDATE_ORGANIZATION_SELECTED_WORKSPACE_STAFF_SELECT_STATE | UPDATE_ORGANIZATION_SELECTED_WORKSPACE_STUDENT_SELECT_STATE | UPDATE_ORGANIZATION_TEMPLATES |
  UPDATE_WORKSPACES_AVAILABLE_FILTERS_EDUCATION_TYPES | UPDATE_WORKSPACES_AVAILABLE_FILTERS_STATE_TYPES | UPDATE_WORKSPACES_AVAILABLE_FILTERS_CURRICULUMS | UPDATE_WORKSPACES_STATE |
