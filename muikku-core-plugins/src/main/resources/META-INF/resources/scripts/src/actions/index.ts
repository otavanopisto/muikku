...
// I added the new workspace stuff only. Everything else is behind the materials redesign branch
...
// Deprecating courses ---> workspaces

  import { UPDATE_COURSES_AVAILABLE_FILTERS_CURRICULUMS, UPDATE_COURSES_AVAILABLE_FILTERS_EDUCATION_TYPES, UPDATE_COURSES_STATE,
  UPDATE_COURSES_ALL_PROPS, UPDATE_COURSES_ACTIVE_FILTERS, UPDATE_COURSES_AVAILABLE_FILTERS_ORGANIZATIONS, UPDATE_ORGANIZATION_COURSES_AVAILABLE_FILTERS_EDUCATION_TYPES, UPDATE_ORGANIZATION_COURSES_AVAILABLE_FILTERS_CURRICULUMS,  UPDATE_ORGANIZATION_COURSES_ALL_PROPS, UPDATE_ORGANIZATION_COURSES_STATE } from './main-function/courses';
...
import { UPDATE_RECORDS_ALL_STUDENT_USERS_DATA, UPDATE_RECORDS_ALL_STUDENT_USERS_DATA_STATUS,
  ...
  UPDATE_RECORDS_SET_FILES, // This was the only thing added, check out during conflcts
...
REMOVE_FROM_MESSAGES_SELECTED_THREADS | UPDATE_UNREAD_MESSAGE_THREADS_COUNT | UPDATE_LAST_WORKSPACE | UPDATE_USER_WORKSPACES | UPDATE_MESSAGE_THREADS |
...
UPDATE_COURSES_AVAILABLE_FILTERS_EDUCATION_TYPES | UPDATE_COURSES_AVAILABLE_FILTERS_CURRICULUMS | UPDATE_COURSES_AVAILABLE_FILTERS_ORGANIZATIONS 
|UPDATE_COURSES_STATE | UPDATE_ORGANIZATION_COURSES_AVAILABLE_FILTERS_EDUCATION_TYPES | UPDATE_ORGANIZATION_COURSES_AVAILABLE_FILTERS_CURRICULUMS |UPDATE_ORGANIZATION_COURSES_ALL_PROPS
| UPDATE_ORGANIZATION_COURSES_STATE |
UPDATE_COURSES_ALL_PROPS | UPDATE_COURSES_ACTIVE_FILTERS | 




UPDATE_GUIDER_AVAILABLE_FILTERS_LABELS | UPDATE_WORKSPACES_AVAILABLE_FILTERS_EDUCATION_TYPES | UPDATE_WORKSPACES_AVAILABLE_FILTERS_CURRICULUMS | UPDATE_WORKSPACES_STATE |
...
UPDATE_HOPS | UPDATE_HOPS_STATUS | UPDATE_ERROR | SET_PROFILE_USER_PROPERTY | SET_PROFILE_USERNAME | SET_PROFILE_ADDRESSES | SET_PROFILE_STUDENT | LOAD_CREDENTIALS | CREDENTIALS_STATE | SET_PROFILE_CHAT_SETTINGS |

UPDATE_STUDENT_USERS | UPDATE_STAFF_USERS | UPDATE_USERS_STATE | UPDATE_RECORDS_SET_FILES | SET_CURRENT_WORKSPACE | UPDATE_WORKSPACE_ASSESSMENT_STATE | UPDATE_WORKSPACE | UPDATE_WORKSPACES_SET_CURRENT_MATERIALS |
UPDATE_WORKSPACES_SET_CURRENT_MATERIALS_ACTIVE_NODE_ID | UPDATE_WORKSPACES_SET_CURRENT_MATERIALS_REPLIES |
