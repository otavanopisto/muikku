...
import { UPDATE_STUDENT_USERS, UPDATE_STAFF_USERS, UPDATE_USERS_STATE, UPDATE_STUDYPROGRAMME_TYPES, UPDATE_STUDYPROGRAMME_STATUS_TYPE } from './main-function/users';
import {UPDATE_ANNOUNCEMENTS, UPDATE_ANNOUNCEMENTS_STATE, UPDATE_ANNOUNCEMENTS_ALL_PROPERTIES, UPDATE_SELECTED_ANNOUNCEMENTS,
  ...
  UPDATE_ONE_ANNOUNCEMENT, DELETE_ANNOUNCEMENT, SET_CURRENT_ANNOUNCEMENT } from './announcements';
...
import {UPDATE_DISCUSSION_THREADS_STATE, UPDATE_DISCUSSION_THREADS_ALL_PROPERTIES, PUSH_DISCUSSION_THREAD_FIRST,
  UPDATE_DISCUSSION_CURRENT_THREAD_STATE, SET_CURRENT_DISCUSSION_THREAD, SET_TOTAL_DISCUSSION_PAGES, SET_TOTAL_DISCUSSION_THREAD_PAGES, UPDATE_DISCUSSION_THREAD, UPDATE_DISCUSSION_THREAD_REPLY, SET_DISCUSSION_WORKSPACE_ID} from './discussion';
import {SET_USER_INDEX, SET_USER_GROUP_INDEX, SET_USER_BY_SCHOOL_DATA_INDEX} from './user-index';
import {UPDATE_USER_WORKSPACES, UPDATE_LAST_WORKSPACE, SET_CURRENT_WORKSPACE, UPDATE_WORKSPACE_ASSESSMENT_STATE,
  ...
  UPDATE_WORKSPACES_AVAILABLE_FILTERS_ORGANIZATIONS} from './workspaces';
...
import { UPDATE_RECORDS_ALL_STUDENT_USERS_DATA, UPDATE_RECORDS_ALL_STUDENT_USERS_DATA_STATUS,
  ...
  UPDATE_RECORDS_CURRENT_STUDENT_AND_WORKSPACE, UPDATE_RECORDS_SET_FILES} from './main-function/records';
...
import { SET_PROFILE_USER_PROPERTY, SET_PROFILE_USERNAME, SET_PROFILE_ADDRESSES, SET_PROFILE_STUDENT, SET_PROFILE_CHAT_SETTINGS } from './main-function/profile';
...
REMOVE_FROM_MESSAGES_SELECTED_THREADS | UPDATE_UNREAD_MESSAGE_THREADS_COUNT | UPDATE_LAST_WORKSPACE | SET_CURRENT_WORKSPACE | UPDATE_WORKSPACE_ASSESSMENT_STATE | UPDATE_USER_WORKSPACES | UPDATE_MESSAGE_THREADS |
...
DELETE_DISCUSSION_AREA | SET_USER_INDEX | PUSH_DISCUSSION_THREAD_FIRST | UPDATE_DISCUSSION_CURRENT_THREAD_STATE | SET_CURRENT_DISCUSSION_THREAD | SET_TOTAL_DISCUSSION_PAGES | SET_TOTAL_DISCUSSION_THREAD_PAGES | UPDATE_DISCUSSION_THREAD |
UPDATE_DISCUSSION_THREAD_REPLY | SET_DISCUSSION_WORKSPACE_ID | PUSH_MESSAGE_LAST_IN_CURRENT_THREAD | SET_USER_GROUP_INDEX |  SET_USER_BY_SCHOOL_DATA_INDEX |
UPDATE_ORGANIZATION_WORKSPACES_AVAILABLE_FILTERS_EDUCATION_TYPES | UPDATE_ORGANIZATION_WORKSPACES_AVAILABLE_FILTERS_CURRICULUMS | UPDATE_ORGANIZATION_WORKSPACES_ALL_PROPS | UPDATE_ORGANIZATION_WORKSPACES_ACTIVE_FILTERS | UPDATE_ORGANIZATION_WORKSPACES_STATE |
UPDATE_CURRENT_COMPOSITE_REPLIES_UPDATE_OR_CREATE_COMPOSITE_REPLY_STATE_VIA_ID_NO_ANSWER | UPDATE_MATERIAL_CONTENT_NODE | DELETE_MATERIAL_CONTENT_NODE | INSERT_MATERIAL_CONTENT_NODE | UPDATE_PATH_FROM_MATERIAL_CONTENT_NODES | UPDATE_WORKSPACES_EDIT_MODE_STATE |
UPDATE_WORKSPACES_SET_CURRENT_HELP | UPDATE_WORKSPACES_AVAILABLE_FILTERS_ORGANIZATIONS |
...
UPDATE_WORKSPACES_ALL_PROPS | UPDATE_WORKSPACES_ACTIVE_FILTERS | UPDATE_WORKSPACE | UPDATE_WORKSPACES_SET_CURRENT_MATERIALS |
UPDATE_WORKSPACES_SET_CURRENT_MATERIALS_ACTIVE_NODE_ID | UPDATE_WORKSPACES_SET_CURRENT_MATERIALS_REPLIES | UPDATE_GUIDER_AVAILABLE_FILTERS_LABELS |
...
SET_DISCUSSION_WORKSPACE_ID | UPDATE_HOPS | UPDATE_HOPS_STATUS | UPDATE_ERROR | SET_PROFILE_USER_PROPERTY | SET_PROFILE_USERNAME | SET_PROFILE_ADDRESSES | SET_PROFILE_STUDENT | SET_PROFILE_CHAT_SETTINGS |
...
UPDATE_STUDENT_USERS | UPDATE_STAFF_USERS | UPDATE_STUDYPROGRAMME_TYPES | UPDATE_STUDYPROGRAMME_STATUS_TYPE |  UPDATE_USERS_STATE | UPDATE_RECORDS_SET_FILES | SET_CURRENT_WORKSPACE | UPDATE_WORKSPACE_ASSESSMENT_STATE | UPDATE_WORKSPACE | UPDATE_WORKSPACES_SET_CURRENT_MATERIALS |
UPDATE_WORKSPACES_SET_CURRENT_MATERIALS_ACTIVE_NODE_ID | UPDATE_WORKSPACES_SET_CURRENT_MATERIALS_REPLIES |
...
INSERT_MATERIAL_CONTENT_NODE | UPDATE_PATH_FROM_MATERIAL_CONTENT_NODES | UPDATE_WORKSPACES_EDIT_MODE_STATE | UPDATE_WORKSPACES_SET_CURRENT_HELP | UPDATE_WORKSPACES_AVAILABLE_FILTERS_ORGANIZATIONS
=======
...
UPDATE_RECORDS_CURRENT_STUDENT_AND_WORKSPACE_STATUS | UPDATE_RECORDS_CURRENT_STUDENT_AND_WORKSPACE | UPDATE_STUDIES_SUMMARY | UPDATE_STUDIES_SUMMARY_STATUS |
UPDATE_STUDIES_STATISTICS | UPDATE_STUDIES_STATISTICS_STATUS | UPDATE_STUDIES_YO | UPDATE_STUDIES_YO_STATUS | UPDATE_STUDIES_YO_SUBJECTS |
UPDATE_STUDIES_YO_ELIGIBILITY_STATUS | UPDATE_STUDIES_YO_ELIGIBILITY | UPDATE_STUDIES_SUBJECT_ELIGIBILITY | UPDATE_STUDIES_SUBJECT_ELIGIBILITY_STATUS | UPDATE_VOPS | UPDATE_VOPS_STATUS |
UPDATE_HOPS | UPDATE_HOPS_STATUS |  UPDATE_HOPS_ELIGIBILITY | UPDATE_ERROR | SET_PROFILE_USER_PROPERTY | SET_PROFILE_USERNAME | SET_PROFILE_ADDRESSES | SET_PROFILE_STUDENT |
LOAD_CREDENTIALS | CREDENTIALS_STATE | UPDATE_RECORDS_SET_FILES | UPDATE_STUDENT_USERS | UPDATE_STAFF_USERS | UPDATE_USERS_STATE | UPDATE_STUDYPROGRAMME_TYPES | UPDATE_STUDYPROGRAMME_STATUS_TYPE
>>>>>>> 76d18308037fe024e3f08d362ed4defff42ba3ba
