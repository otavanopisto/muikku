...
import {SET_USER_INDEX, SET_USER_GROUP_INDEX} from '~/actions/main-function/user-index';
...
UPDATE_DISCUSSION_THREAD_REPLY | PUSH_MESSAGE_LAST_IN_CURRENT_THREAD | SET_USER_GROUP_INDEX
