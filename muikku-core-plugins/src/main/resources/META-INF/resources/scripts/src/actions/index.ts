...
import { UPDATE_STUDENT_USERS, UPDATE_STAFF_USERS, UPDATE_USER_GROUPS, UPDATE_STUDENT_SELECTOR,
  ...
  UPDATE_STUDYPROGRAMME_STATUS_TYPE, UPDATE_CURRENT_USER_GROUP, UPDATE_USER_GROUPS_STATE, UPDATE_HAS_MORE_USEGROUPS
