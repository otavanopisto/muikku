...
export type ActionType = SET_CURRENT_MESSAGE_THREAD | UPDATE_MESSAGES_STATE |
  ...
  INSERT_MATERIAL_CONTENT_NODE | UPDATE_PATH_FROM_MATERIAL_CONTENT_NODES | UPDATE_WORKSPACES_EDIT_MODE_STATE | UPDATE_WORKSPACES_SET_CURRENT_HELP | SET_PROFILE_CHAT_SETTINGS | TOGGLE_ALL_MESSAGE_ITEMS
