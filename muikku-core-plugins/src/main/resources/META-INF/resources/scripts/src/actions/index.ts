...
import { UPDATE_GUIDER_FILTERS_LABELS, UPDATE_GUIDER_FILTERS_WORKSPACES, UPDATE_GUIDER_FILTERS_ADD_LABEL } from '~/actions/main-function/guider/guider-filters';
...
UPDATE_GUIDER_FILTERS_ADD_LABEL
