...
import { UPDATE_CREDENTIALS, LOAD_CREDENTIALS, CREDENTIALS_STATE } from './base/credentials';
...
UPDATE_HOPS | UPDATE_HOPS_STATUS | UPDATE_ERROR | SET_PROFILE_USER_PROPERTY | SET_PROFILE_USERNAME | SET_PROFILE_ADDRESSES | SET_PROFILE_STUDENT | LOAD_CREDENTIALS | UPDATE_CREDENTIALS | CREDENTIALS_STATE 
