...
import {
  ...
  UPDATE_ORGANIZATION_WORKSPACES_AVAILABLE_FILTERS_EDUCATION_TYPES, UPDATE_ORGANIZATION_WORKSPACES_AVAILABLE_FILTERS_CURRICULUMS, UPDATE_ORGANIZATION_WORKSPACES_ALL_PROPS, UPDATE_ORGANIZATION_SELECTED_WORKSPACE,
