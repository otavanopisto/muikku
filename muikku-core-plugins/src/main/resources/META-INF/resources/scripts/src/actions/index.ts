...
export type ActionType = SET_CURRENT_MESSAGE_THREAD | UPDATE_MESSAGES_STATE |
  ...
  UPDATE_STUDENT_USERS | UPDATE_STAFF_USERS | UPDATE_STUDYPROGRAMME_TYPES | UPDATE_STUDYPROGRAMME_STATUS_TYPE | UPDATE_USERS_STATE | SET_CURRENT_WORKSPACE | UPDATE_WORKSPACE_ASSESSMENT_STATE | UPDATE_WORKSPACE | UPDATE_WORKSPACES_SET_CURRENT_MATERIALS |
  UPDATE_WORKSPACES_SET_CURRENT_MATERIALS_ACTIVE_NODE_ID | UPDATE_WORKSPACES_SET_CURRENT_MATERIALS_REPLIES |
