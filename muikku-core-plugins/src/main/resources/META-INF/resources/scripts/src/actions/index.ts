...
UPDATE_RECORDS_CURRENT_STUDENT_AND_WORKSPACE_STATUS | UPDATE_RECORDS_CURRENT_STUDENT_AND_WORKSPACE | UPDATE_STUDIES_SUMMARY | UPDATE_STUDIES_SUMMARY_STATUS | UPDATE_VOPS | UPDATE_VOPS_STATUS |
