...
const initializeHops = (): HopsCompulsory => ({
  ...
  motivationAndStudy: {
    wayToLearn: {
      byReadingMaterials: 1,
      byTakingNotes: 1,
      byDoingExcercises: 1,
      byMemorizing: 1,
      byWatchingVideos: 1,
      byListeningTeaching: 1,
      byExplaining: 1,
      byDiscussing: 1,
      byWatchingOrDoingExamples: 1,
    ...
    selfImageAsStudent: {
      likeStudying: 1,
      haveGoals: 1,
      readyToAchieveGoals: 1,
      alwaysFinishJobs: 1,
      bePedantic: 1,
      studyingConcentration: 1,
      affectedByNoise: 1,
      canFollowInstructions: 1,
      canEvaluateOwnWork: 1,
      canTakeFeedback: 1,
      canUseBasicComputerFunctionalities: 1,
      somethingElse: "",
