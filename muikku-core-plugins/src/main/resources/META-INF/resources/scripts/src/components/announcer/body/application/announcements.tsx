...
import {
  AddToAnnouncementsSelectedTriggerType, RemoveFromAnnouncementsSelectedTriggerType,
  removeFromAnnouncementsSelected, addToAnnouncementsSelected
} from '~/actions/announcements';
import DeleteAnnouncementDialog from '../../dialogs/delete-announcement';
import ApplicationList, { ApplicationListItem, ApplicationListItemContentWrapper, ApplicationListItemFooter, ApplicationListItemBody, ApplicationListItemHeader, ApplicationListHeaderPrimary, ApplicationListItemDate } from '~/components/general/application-list';
              ...
              return <ApplicationListItemContentWrapper className="announcement__content" aside={<div className="announcement__select-container">
                ...
                <ApplicationListItemHeader>
                  <ApplicationListHeaderPrimary>
                    <ApplicationListItemDate startDate={this.props.i18n.time.format(announcement.startDate)} endDate={this.props.i18n.time.format(announcement.endDate)} />
                  </ApplicationListHeaderPrimary>
                </ApplicationListItemHeader>
