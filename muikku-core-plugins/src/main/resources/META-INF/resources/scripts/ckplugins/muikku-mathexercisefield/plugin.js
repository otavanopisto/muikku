    ...
    init: function (editor) {
      ...
      editor.addCommand('createMuikkuMathExerciseField', {
        exec: function (editor) {
          ...
          var fakeElement = editor.createFakeElement(object, 'muikku-mathexercise-field', 'muikkumathexercisefield', true);
          fakeElement.setAttribute('src', CKEDITOR.plugins.getPath('muikku-mathexercisefield') + 'gfx/muikku-placeholder-mathexercise.gif');
          fakeElement.setAttribute('title', editor.lang['muikku-mathexercisefield'].uiElement);
