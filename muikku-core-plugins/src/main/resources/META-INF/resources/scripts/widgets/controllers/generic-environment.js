module([
  ...
  $.widget("custom.genericEvironmentControllerWidget", {
    _create: function(){
      var self = this;
      var dropdowns = self.element.find(".dropdown").dropdownWidget();
      self.element.find(".menu").menuWidget();
      
      self.element.find(".generic-environment-interact-show-language-picker").click(function(e){
        dropdowns.siblings("#generic-environment-language-picker").dropdownWidget('open', e.currentTarget);
      });
      self.element.find(".generic-environment-interact-show-profile-menu").click(function(e){
        dropdowns.siblings("#generic-environment-profile-menu").dropdownWidget('open', e.currentTarget);
      });
