    ...
    _create: function () {
      ...
      this._editor = $(this._editorContainer).coOpsCK({
        externalPlugins : {
          ...
          'muikku-audiofield': CONTEXTPATH + '/scripts/ckplugins/muikku-audiofield/',
          ...
          'muikku-sorterfield': CONTEXTPATH + '/scripts/ckplugins/muikku-sorterfield/',
          'muikku-mathexercisefield': CONTEXTPATH + '/scripts/ckplugins/muikku-mathexercisefield/',
