    ...
    _create: function () {
      ...
      this._editor = $(this._editorContainer).coOpsCK({
        externalPlugins : {
          ...
          'change' : '//cdn.muikkuverkko.fi/libs/coops-ckplugins/change/0.1.0/plugin.min.js',
          'coops' : '//cdn.muikkuverkko.fi/libs/coops-ckplugins/coops/0.1.0/plugin.min.js',
          'coops-connector' : '//cdn.muikkuverkko.fi/libs/coops-ckplugins/coops-connector/0.1.0/plugin.min.js',
          'coops-dmp' : '//cdn.muikkuverkko.fi/libs/coops-ckplugins/coops-dmp/0.1.0/plugin.min.js',
          'coops-sessionevents' : '//cdn.muikkuverkko.fi/libs/coops-ckplugins/coops-sessionevents/0.1.0/plugin.min.js',
