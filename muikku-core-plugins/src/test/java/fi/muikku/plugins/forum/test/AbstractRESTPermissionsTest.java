...
//    }
  ...
  public boolean roleIsAllowed(EnvironmentRoleArchetype environmentRoleArchetype, List<EnvironmentRoleArchetype> allowedRoles) {
...
//      response.then().assertThat().statusCode(400);
  ...
  protected EnvironmentRoleArchetype getRole() {
    return role;
  }

  protected void setRole(EnvironmentRoleArchetype role) {
    this.role = role;
  }

  protected EnvironmentRoleArchetype role;
