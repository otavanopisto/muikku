...
import { MatriculationExamEnrolledSubject } from "~/generated/client";
...
interface MatriculationExaminationEnrolledAttendesListProps {
  onChange?: (
    modifiedExaminationAttendedSubjectList: MatriculationExamEnrolledSubject[]
  ) => void;
  readOnly?: boolean;
  ...
  examinationEnrolledList: MatriculationExamEnrolledSubject[];
