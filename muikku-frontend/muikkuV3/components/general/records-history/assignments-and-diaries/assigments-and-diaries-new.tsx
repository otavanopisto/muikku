 ...
 */
interface AssignmentsAndDiariesNewProps {
  /**
 ...
 * @returns JSX.Element
 */
const AssignmentsAndDiariesNew: React.FC<AssignmentsAndDiariesNewProps> = (
  props
) => {
...
export default connect(null, mapDispatchToProps)(AssignmentsAndDiariesNew);
