 ...
 */
interface TransfereCreditIndicatorNewProps {
 ...
 * @returns JSX.Element
 */
const TransferedCreditIndicatorNew: React.FC<
  TransfereCreditIndicatorNewProps
> = (props) => {
...
export default TransferedCreditIndicatorNew;
