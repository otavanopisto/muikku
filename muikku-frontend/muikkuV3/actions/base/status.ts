...
async function loadWhoAMI(
  ...
  dispatch({
    ...
    payload: {
      ...
      isSpecialEducationTeacher: whoAmI.specialEducationTeacher,
      ...
      profile: {
        ...
        educationTypeCode: whoAmI.educationTypeCode,
      },
    },
  });
  ...
  dispatch({
    ...
    payload: {
      permissions: {
        ...
        WORKSPACE_SHOW_EXAMS: permissions.includes("SHOW_EXAMS"),
