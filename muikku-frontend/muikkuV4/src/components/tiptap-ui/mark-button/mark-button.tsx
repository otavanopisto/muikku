...
/**
 * The MarkShortcutBadge component.
 * @param props - The props for the MarkShortcutBadge component.
 * @returns The MarkShortcutBadge component.
 */
