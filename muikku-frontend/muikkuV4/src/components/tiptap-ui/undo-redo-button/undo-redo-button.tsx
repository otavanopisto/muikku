...
/**
 * The UndoRedoButton props interface.
 */
...
/**
 * The History shortcut badge component.
 * @param props - The props for the History shortcut badge component.
 * @returns The History shortcut badge component.
 */
