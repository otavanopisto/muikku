...
/**
 * The TextAlignButtonProps interface.
 */
...
/**
 * The TextAlignShortcutBadge component.
 * @param props - The props for the TextAlignShortcutBadge component.
 * @returns The TextAlignShortcutBadge component.
 */
