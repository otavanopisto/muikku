...
public class EnvironmentUserRolePermissionDAO extends CoreDAO<EnvironmentUserRolePermission> {
	...
	public EnvironmentUserRolePermission create(UserRole userRole, Permission permission) {
	...
	public boolean hasEnvironmentPermissionAccess(UserRole userRole, Permission permission) {
		return findByUserRoleAndPermission(userRole, permission) != null;
	}

	public EnvironmentUserRolePermission findByUserRoleAndPermission(UserRole userRole, Permission permission) {
		...
		criteria.where(criteriaBuilder.and(criteriaBuilder.equal(root.get(EnvironmentUserRolePermission_.userRole), userRole),
