...
public class UserContactRestModel {

  public UserContactRestModel() {
  }

  public UserContactRestModel(Long id, String name, String phoneNumber, String email, String streetAddress, String postalCode, String city, String country, String contactType, boolean defaultContact, Boolean allowStudyDiscussions, OffsetDateTime allowStudyDiscussionsModified) {
    this.id = id;
    this.name = name;
