...
@ApplicationScoped
public class CalendarPermissions extends AbstractMuikkuPermissionCollection implements MuikkuPermissionCollection {
  ...
  public List<String> listPermissions() {
    return listPermissions(CalendarPermissions.class);
  }
