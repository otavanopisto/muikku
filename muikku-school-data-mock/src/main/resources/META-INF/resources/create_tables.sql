...
ALTER TABLE UserRole ADD CONSTRAINT FK_USERROLE_USER_ID FOREIGN KEY (user_id)  REFERENCES User (id) ON DELETE CASCADE;
ALTER TABLE UserRole ADD CONSTRAINT FK_USERROLE_ROLE_ID FOREIGN KEY (role_id)  REFERENCES Role (id) ON DELETE CASCADE;
ALTER TABLE UserWorkspaceRole ADD CONSTRAINT FK_USERWORKSPACEROLE_ID FOREIGN KEY (id)  REFERENCES UserRole (id) ON DELETE CASCADE;
