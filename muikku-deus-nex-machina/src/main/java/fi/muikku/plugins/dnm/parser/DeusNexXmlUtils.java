...
public class DeusNexXmlUtils {
	...
	public static String serializeElement(Element element, boolean omitXmlDeclaration, boolean indent, String method, String version) throws TransformerException {
