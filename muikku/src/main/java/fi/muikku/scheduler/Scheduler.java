...
public class Scheduler {
	...
	@Inject
	@Scheduled (schedule = fi.muikku.scheduler.Schedule.MONTHLY)
	private Event<ScheduledEvent> monthlyEvent;
	
	@Inject
	@Scheduled (schedule = fi.muikku.scheduler.Schedule.WEEKLY)
	private Event<ScheduledEvent> weeklyEvent;
	
	@Inject
	@Scheduled (schedule = fi.muikku.scheduler.Schedule.DAILY)
	private Event<ScheduledEvent> dailyEvent;
	
	@Inject
	@Scheduled (schedule = fi.muikku.scheduler.Schedule.HOURLY)
	private Event<ScheduledEvent> hourlyEvent;
	
	@Inject
	@Scheduled (schedule = fi.muikku.scheduler.Schedule.EVERY_HALF_HOUR)
	private Event<ScheduledEvent> everyHalfHourEvent;
	
	@Inject
	@Scheduled (schedule = fi.muikku.scheduler.Schedule.EVERY_FIFTEEN_MINUTES)
	private Event<ScheduledEvent> everyFifteenMinutesEvent;
	
	@Inject
	@Scheduled (schedule = fi.muikku.scheduler.Schedule.EVERY_FIVE_MINUTES)
	private Event<ScheduledEvent> everyFiveMinutesEvent;
	
	@Inject
	@Scheduled (schedule = fi.muikku.scheduler.Schedule.EVERY_MINUTE)
