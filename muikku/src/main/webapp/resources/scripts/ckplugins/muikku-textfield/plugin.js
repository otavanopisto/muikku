...
(function() {
  ...
  function createFakeParserElement(editor, realElement) {
    var fake = editor.createFakeParserElement(realElement, 'muikku-text-field',
        'muikkutextfield', true);
    fake.attributes.src = CKEDITOR.plugins.getPath('muikku-textfield')
        + 'gfx/muikku-placeholder-textfield.gif';
    fake.attributes.title = editor.lang['muikku-textfield'].uiElement;
    return fake;
  }

  function createFakeElement(editor, realElement) {
    var fake = editor.createFakeElement(realElement, 'muikku-text-field',
        'muikkutextfield', true);
    fake.setAttribute('src', CKEDITOR.plugins.getPath('muikku-textfield')
        + 'gfx/muikku-placeholder-textfield.gif');
  ...
  CKEDITOR.plugins.add('muikku-textfield', {
    ...
    init : function(editor) {
      editor.addCommand('muikkutextfield', new CKEDITOR.dialogCommand(
          'muikkutextfield', {}));
      ...
      editor.on('doubleclick', function(evt) {
        ...
        if (element.is('img')
            && element.data('cke-real-element-type') == 'muikkutextfield')
    ...
    afterInit : function(editor) {
      var dataProcessor = editor.dataProcessor, dataFilter = dataProcessor
          ...
          answersElement.prototype,
          {
            ...
            setupContainers : function(label) {
              ...
              var optionsContainer = uiElement
                  .findOne('.textfield-elements-container');
            ...
            getAnswersCount : function() {
              return this.getElement().find('.textfield-element-container')
                  .count();
            }
      ...
      .add(
          ...
          function(editor) {
            return {
              ...
              minHeight : 310,
              onShow : function() {
                var contentJson = editor.getMuikkuFieldDefinition(editor
              ...
              onOk : function(event) {
                ...
                var newJson = {
                  ...
                  'columns' : this.getContentElement('info', 'width')
                      .getValue(),
