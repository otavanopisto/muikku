...
insert into PluginSettingKey(name, plugin) select 'pyramusOrigin', 'school-data-pyramus' from PluginSettingKey where plugin = 'school-data-pyramus' and name = 'pyramusOrigin' having count(*) = 0;
...
insert into PluginSetting (value, key_id) select 'http://dev.muikku.fi:8089', (select id from PluginSettingKey where plugin = 'school-data-pyramus' and name = 'pyramusOrigin') from PluginSetting where key_id = (select id from PluginSettingKey where plugin = 'school-data-pyramus' and name = 'pyramusOrigin') having count(*) = 0;
