...
public final class Common {
  ...
  public static String REDIRECT_URL = "https://localhost:" + System.getProperty("it.port.https") + "/oauth2ClientTest/success";
  public static String AUTH_URL = "https://dev.pyramus.fi:" + System.getProperty("it.port.https") + "/users/authorize.page";
