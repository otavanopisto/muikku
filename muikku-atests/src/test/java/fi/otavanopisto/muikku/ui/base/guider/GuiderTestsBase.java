...
public class GuiderTestsBase extends AbstractUITest {
  ...
  public void filterByNameTest() throws Exception {
    ...
    try {
      ...
      waitForPresent(".application-list__item-header .text--student-name");
      assertTextIgnoreCase(".application-list__item-header .text--student-name", "Second User");
      assertTextIgnoreCase(".application-list .application-list__item-header .text--list-item-helper-title", "te...@example.com");
      assertTextIgnoreCase(".application-list .application-list__item-header .text--list-item-type-title", "Test Study Programme");
    } finally {
  ...
  public void filterByWorkspaceTest() throws Exception {
    ...
    try {
      ...
      waitUntilElementCount(".application-list .user--guider", 1);
      assertTextIgnoreCase(".application-list__item-header .text--student-name", "Test Student");
      assertCount(".application-list__item-header .text--student-name", 1);
    } finally {
      deleteWorkspace(workspace2.getId());
      deleteWorkspace(workspace.getId());
      mockBuilder.wiremockReset();
