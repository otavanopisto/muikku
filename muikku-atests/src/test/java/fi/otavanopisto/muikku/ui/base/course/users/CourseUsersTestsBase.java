...
public class CourseUsersTestsBase extends AbstractUITest {
  ...
  public void courseUsersListTest() throws Exception {
    ...
    try {
      ...
      MockCourseStudent mcs = new MockCourseStudent(1l, course1, student.getId(), TestUtilities.createCourseActivity(course1, CourseActivityState.ONGOING));
      MockCourseStudent mcs2 = new MockCourseStudent(2l, course1, student2.getId(), TestUtilities.createCourseActivity(course1, CourseActivityState.ONGOING));
      MockCourseStudent mcs3 = new MockCourseStudent(3l, course1, student3.getId(), TestUtilities.createCourseActivity(course1, CourseActivityState.ONGOING));
      MockCourseStudent mcs4 = new MockCourseStudent(4l, course1, student4.getId(), TestUtilities.createCourseActivity(course1, CourseActivityState.ONGOING));
