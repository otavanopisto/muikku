  ...
  public void courseUsersListSendMessageToStudentTest() throws Exception {
    ...
    try {
      ...
      try {
        ...
        waitForPresentAndVisible(".env-dialog--new-message.visible .tag-input__selected-item .autocomplete__selected-item");
        assertText(".env-dialog--new-message.visible .tag-input__selected-item .autocomplete__selected-item", "Student Tester");
