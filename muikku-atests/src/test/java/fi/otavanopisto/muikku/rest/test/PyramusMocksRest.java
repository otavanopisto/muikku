...
public class PyramusMocksRest extends AbstractPyramusMocks {
  ...
  private static void mockStudyProgrammes(List<String> payloads) throws JsonProcessingException {
    StudyProgramme[] sps = {
        new StudyProgramme(1l, DEFAULT_ORGANIZATION_ID, "test", "Test Study Programme", 1l, false, false), 
        new StudyProgramme(2l, 2l, "test", "Secondary Organization Study Programme", 1l, false, false) 
    };
