...
public class UserRESTServiceTestsIT extends AbstractRESTTest {
  ...
  public void testFindStudent7AsAdmin() throws NoSuchFieldException {
    ...
    response.then().statusCode(200);
    String expected = "{\"id\":\"PYRAMUS-STUDENT-7\",\"firstName\":\"Constipated\",\"lastName\":\"Moose\",\"nickName\":null,\"studyProgrammeName\":\"Secondary Organization Study Programme\",\"hasImage\":false,\"nationality\":null,\"language\":null,\"municipality\":null,\"school\":null,\"email\":\"co...@example.com\",\"studyStartDate\":\"2010-01-01T00:00:00.000+0000\",\"studyEndDate\":\"2011-01-01T00:00:00.000+0000\",\"studyTimeEnd\":null,\"curriculumIdentifier\":null,\"updatedByStudent\":false,\"userEntityId\":7,\"flags\":null,\"organization\":{\"id\":2,\"name\":\"Secondary Test Organization\"}}";
    JSONAssert.assertEquals(expected, response.body().asString(), STRICT_JSON);
  }
