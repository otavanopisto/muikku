...
public class GuiderTestsBase extends AbstractUITest {
  ...
  public void filterByNameTest() throws Exception {
    ...
    MockStudent student = new MockStudent(2l, 2l, "Second", "User", "teststudent@example.com", 1l, new DateTime(1990, 2, 2, 0, 0, 0, 0), "121212-1212", Sex.FEMALE, TestUtilities.toDate(2012, 1, 1), TestUtilities.getNextYear());
